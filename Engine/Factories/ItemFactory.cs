...
{
    /* Alle mine genstande i "Factories" mappen,
     * er der hvor alt indhold som genstande, opskrifter, verden,
     * kommer til, det er i de "Fabrikker" jeg skaber de forskellige ting */
